...
using Cone.Services.AssignmentStudentGroupService;
...
{
    public static IServiceCollection AddConeServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton(new ConeConfiguration
        {
        ...
        services.AddDataProtection()
            .PersistKeysToDbContext<ConeDbContext>()
            .SetApplicationName("ConeApp");
